...
for((i=0;i<${k};i=i+1))
do
python train.py --arch unet-resnet18 --norm_type bn --dataset siim \
                --img_rows 768 --img_cols 768 --in_channels 3 \
                --n_iter 40400 --batch_size 6 --seed 1234 \
                --l_rate 5e-4 --weight_decay 1e-4 --iter_size 4 \
                --num_cycles 1 --print_train_freq 400 --eval_freq 404 --save_freq 0.01 \
